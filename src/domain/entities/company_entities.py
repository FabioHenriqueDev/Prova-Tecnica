...
class Company:
    ...
    def __init__(self, name, description, website, email, phone, address, business_type):
        ...
        self.email = self.validate_email_company(email)
